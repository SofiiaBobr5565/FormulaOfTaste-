...
```
Мета проєкту:
Створення веб-сайту з рецептами, який містить інтерактивний калькулятор інгредієнтів для розрахунку порцій. Сайт має забезпечувати зручний пошук рецептів, можливість їх перегляду та коректний розрахунок інгредієнтів відповідно до кількості порцій.
