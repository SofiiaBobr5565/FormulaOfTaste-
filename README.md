...
![image](https://github.com/user-attachments/assets/a9ee91d6-4644-4fad-9d6d-cbce6128c863)


### Окупність  
```
Річний прибуток: $42,000

Інвестиції за 6 місяців: $41,700

Окупність: ~ 12 місяців

Через рік після запуску проєкт вийде в нуль і почне приносити прибуток.
Якщо розширити аудиторію та активніше монетизувати трафік, можна збільшити
дохід до $5,000–7,000/міс, що зробить проєкт прибутковим уже за 8–10 місяців.
...
### 7. КОМАНДА ПРОЄКТУ  
 ...
 1. **Frontend-розробник (Шевченко Владислав)**
...
Навички: HTML, CSS, JavaScript, розуміння REST API.
 ...
 2. **Backend-розробник (Варава Артем)**
...
Навички: Ручне тестування, базові знання автоматизованого тестування, уважність до деталей.  
 ...
 5. **Керівник проєкту /Project Manager (Бобровицька Софія)**   
 
Обов’язки:  
Координація роботи команди: постановка задач, контроль термінів, розподіл ресурсів.  
Взаємодія із замовником для уточнення вимог (наприклад, додавання інструкцій чи зміни кольору сердечка).  
